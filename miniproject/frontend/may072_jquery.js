function connectProductRegEvent(){
    $("button").click(function(){
        ...
        var url="http://195.168.9.208:5969/product.reg?p_id=" + c + "&p_name=" + s;
...
function getProductData() {
    $.getJSON("http://195.168.9.208:5969/product.get", function(json) {
...
$(document).ready(function() {
    $("#loginUser").click(function() {
        ...
        var pw = $("#userpwInput").val();

        var url = "http://195.168.9.208:5969/user.reg" +
        // controller에 있는거랑 변수 동일해야함. 
            "?id=" + id +
            "&pw=" + pw;
...
$(document).ready(function() {
    $("#regProductRN").click(function() {
        ...
        var url = "http://195.168.9.208:5969/product.reg" +
            "?p_id=" + c +
            "&p_name=" + f+
            "&p_brand_id=" + s +
            "&p_category_id=" + a +
